...
# Generates small test data (100 pages) in the legacy PostgreSQL database
...
SQL_FILE="$SCRIPT_DIR/generate-small-test-data.sql"

echo "🚀 Starting small test data generation for ShareNote Data Redistribution..."
echo ""
...
# Confirm execution
echo "⚠️  This will generate small test data:"
echo "   - 100 pages"
echo "   - 300 page permissions (3 per page)"
echo "   - 3,000 blocks (30 per page)"
echo ""
echo "   Estimated time: 1-2 seconds"
echo "   Estimated disk space: ~5MB"
echo ""
...
echo ""
echo "⏱️  Starting small data generation..."
echo ""
...
echo "🎉 Small test data generation successful!"
echo ""
echo "📝 Next steps:"
echo "   1. You can now test the data redistribution application with small dataset"
echo "   2. All data is marked with migration_status = 'READY'"
echo "   3. Use ./generate-data.sh for large dataset (50,000 pages)"
echo "   4. Use ./clean-data.sh to remove test data if needed"